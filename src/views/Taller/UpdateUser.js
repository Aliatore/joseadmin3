              ...
              <ToastContainer/>
                ...
                <Row className="mt-2 mb-1" style={{textAlign:"center", placeContent:"center"}}>
                    <Col xs="12" sm="12" md="5" lg="5" xl="5" style={{textAlignLast:"center"}}>
                      <FormGroup>
                        <Label htmlFor="t_user"><MDBIcon className="mt-1" size="lg" icon="user"/> Selecciona el usuario al que deseas actualizar</Label>
                        <Input
                          type="select" 
                          id="t_user" 
              ...
              <Container style={{textAlign:"center"}}>
                ...
                <Form className="pt-2 ml-3" onSubmit={registerNewUser}>
                  ...
                  <Row>
                    <Col xs="12" sm="12" md="6" lg="4" xl="3">
                      <FormGroup>
                        <Label htmlFor="t_user"><MDBIcon className="mt-1" size="lg" icon="user"/> Género</Label>
                        <Input
                          type="select" 
                          id="t_user" 
